...
//pt N(float a, pt A, float b, pt B, float t){pt P=new pt(A.x,A.y).add(S((t-a)/(b-a),V(A,B))); return P;}
pt N(float a, pt A, float b, pt B, float t) {return P((A.x*((b-t)/(b-a)))+(B.x*((t-a)/(b-a))), (A.y*((b-t)/(b-a)))+(B.y*((t-a)/(b-a))));}
